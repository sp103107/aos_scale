...
class ActionType(str, Enum):
    ...
    SCALE_DEVICE_ID_SET = "scale.device_id.set"
    SCALE_PROFILE_LIST = "scale.profile.list"
    SCALE_PROFILE_ACTIVATE = "scale.profile.activate"
    SCALE_PROFILE_ARCHIVE = "scale.profile.archive"
    SCALE_PROFILE_RENAME = "scale.profile.rename"
    SCALE_CALIBRATION_CHARACTERIZE = "scale.calibration.characterize"
    SCALE_PROFILE_CONFIRM_STABILITY = "scale.profile.confirm_stability"
