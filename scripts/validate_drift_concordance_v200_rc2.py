"""
BBWS SR7 drift concordance for product version 2.0.0-rc2.
...
def main() -> int:
    ...
    report = {
        "gate": "drift_concordance_v200_rc2",
        "status": status,
        ...
        "issues": issues,
        "non_claims": [
            "Archival v0.1.9 manifests and the v200_rc1 gate are not rewritten",
            "Not legal-for-trade / Metrc compliance",
        ],
    }
    out = ROOT / "reports" / "drift_concordance_report.v2.0.0-rc2.json"
