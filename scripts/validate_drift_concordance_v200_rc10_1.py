"""
BBWS SR16 patch drift concordance for product version 2.0.0-rc10.1.

Checks key human/agent doors and packaging version surfaces. Does not rewrite
archival v200_rc10 or earlier gates.
"""
...
PRODUCT = "2.0.0-rc10.1"
PYPROJECT_PEP440 = "2.0.0rc10.post1"
...
def main() -> int:
    ...
    report = {
        "gate": "drift_concordance_v200_rc10_1",
        "status": status,
