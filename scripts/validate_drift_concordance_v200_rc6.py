"""
BBWS SR10 drift concordance for product version 2.0.0-rc6.
...
def main() -> int:
    ...
    report = {
        "gate": "drift_concordance_v200_rc6",
        "status": status,
        ...
        "issues": issues,
        "non_claims": [
            "Archival v0.1.9 manifests and the v200_rc1/rc2/rc3/rc4/rc5 gates are not rewritten",
            "Not legal-for-trade / Metrc compliance",
            "Scale profiles/receipts are local operational evidence only; not legal-for-trade",
        ],
    }
    out = ROOT / "reports" / "drift_concordance_report.v2.0.0-rc6.json"
