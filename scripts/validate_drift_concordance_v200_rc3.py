"""
BBWS SR8 drift concordance for product version 2.0.0-rc3.
...
retired v200_rc1 / v200_rc2 gates.
"""
...
def main() -> int:
    ...
    report = {
        "gate": "drift_concordance_v200_rc3",
        "status": status,
        ...
        "issues": issues,
        "non_claims": [
            "Archival v0.1.9 manifests and the v200_rc1/rc2 gates are not rewritten",
            "Not legal-for-trade / Metrc compliance",
            "Scale Face is a UI mode, not a separate weighing server",
        ],
    }
    out = ROOT / "reports" / "drift_concordance_report.v2.0.0-rc3.json"
