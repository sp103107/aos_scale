...
EXCLUDED_DIRS={'.git','.pytest_cache','__pycache__','build'}
def included(path:Path)->bool:
    rel=path.relative_to(ROOT)
    if path==OUT or any(part in EXCLUDED_DIRS for part in rel.parts): return False
