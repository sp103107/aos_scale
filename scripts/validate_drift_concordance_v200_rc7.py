"""
BBWS SR12 drift concordance for product version 2.0.0-rc7.
...
retired v200_rc1 / v200_rc2 / v200_rc3 / v200_rc4 / v200_rc5 / v200_rc6 gates.
"""
...
def main() -> int:
    ...
    report = {
        "gate": "drift_concordance_v200_rc7",
        "status": status,
    ...
    out = ROOT / "reports" / "drift_concordance_report.v2.0.0-rc7.json"
